    ...
    <div class="hero" style=" color:whitesmoke; height: 1700px;">
      ...
      <!--	images in home page-->
            <div class="floating-area">
                <img class="floating" src="img/zero.png" width="42%" style="padding-top:90px; padding-left: 50px; padding-bottom:100px; float: left;"/>
            </div>
             ...
             <!-- Texts in home page with heading and sub texts-->
                  <div class="animated slideInRight">
                   <h1 style="padding-top:250px; padding-right:290px; font-size: 30px; float: right; text-align : center;">
                       <strong style="'Times New Roman', Times, serif">Welcome to JobHunt</strong>
                   </h1>
