...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse" style="box-shadow: 0px 3px 4px rgba(225, 225, 225, .6); font-family: 'Times New Roman', Times, serif">
  <div class="container-fluid"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php" style="padding-left: 50px; font-size:25px; color:white; font-family: 'Times New Roman', Times, serif">
          JobHunt
      </a> 
    </div>
    ...
    <div class="collapse navbar-collapse" id="defaultNavbar1" style="padding-right:50px;">
      <ul class="nav navbar-nav navbar-right ">
        ...
        if (isset($_SESSION['login_user'])) {
            ...
            echo '<li><a id="loginAnchor" href="#" data-toggle="modal" data-target="#myEmployerModal">Sign In</a></li>';
            echo '<li><a id="registerLink" href="#" data-toggle="modal" data-target="#empsignup">Register</a></li>'; // Add the Register link
        }
